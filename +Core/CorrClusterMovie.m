classdef CorrClusterMovie < Core.Movie
    ...
    methods
        ...
        function [corrR] = getPxCorrelation(obj,data,corrInfo)
...
%                 sumPx   = obj.corrRelation.sumCorrPx;
                ...
                [corrMask,cleanedCorrMask] = corrAnalysis.bottomUpCorrClustering(obj.corrRelation,data);
